  ...
  ext_modules = [
    ...
    Extension('spartan.examples.cf.helper', ['spartan/examples/cf/helper' + suffix]),
     Extension('spartan.fastrpc.serialization_buffer', 
              ['spartan/fastrpc/serialization_buffer' + suffix]),
    ...
    Extension('spartan.examples.sklearn.util.graph_shortest_path', 
     ...
     Extension('spartan.blob_ctx', 
              ['spartan/blob_ctx' + suffix], 
              language='c++',
              include_dirs = ['/usr/local/include', 'spartan/fastrpc/simple-rpc', 'spartan/fastrpc/base-utils', 'spartan/fastrpc/simple-rpc/build'],
              library_dirs = ['/usr/lib', 'spartan/fastrpc/base-utils/build', 'spartan/fastrpc/simple-rpc/build'],
