...
public:
    enum {
        INITIALIZE = 0x6772bd87,
        CREATE_TABLE = 0x108639c3,
        DESTROY_TABLE = 0x20c330d2,
        GET = 0x1248aca3,
        ASSIGN_SHARDS = 0x1603f09b,
        RUN_KERNEL = 0x3d917ebe,
        GET_ITERATOR = 0x30f668e5,
        PUT = 0x1cbecc9e,
        FLUSH = 0x4079f6e8,
        SHUTDOWN = 0x4c0c99b9,
    };
