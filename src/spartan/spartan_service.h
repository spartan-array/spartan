...
public:
    enum {
        INITIALIZE = 0x53273dfa,
        CREATE_TABLE = 0x1c0cda59,
        DESTROY_TABLE = 0x369436bf,
        GET = 0x1e9a23c5,
        ASSIGN_SHARDS = 0x31199a55,
        RUN_KERNEL = 0x41341fe8,
        GET_ITERATOR = 0x40f4154a,
        PUT = 0x2bad0678,
        FLUSH = 0x2e976ad9,
        SHUTDOWN = 0x679f65cc,
    };
